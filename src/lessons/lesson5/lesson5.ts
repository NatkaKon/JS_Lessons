...
type counterType = {
    ...
    setCurrentCount: (newNumber: number) => counterType
...
const newPerson = new (myFirstConstructorFunc as any)('Anna', 18)
...
// }
// //One.name = helperObj.changeName('Mike')
//
// console.log(helperObj.changeName('Mike'))
// console.log(helperObj.setAge(55))
...
const bindNumber=(func:number, number:number)=> {
    console.log(func+number)
}
bindNumber(sumTwoNumbers(1,2), 10)
